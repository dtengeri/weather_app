...
abstract class $TemperatureCopyWith<$Res> {
  ...
  @useResult
  $Res call({double value, TemperatureUnit unit});
}
...
class _$TemperatureImpl extends _Temperature {
  const _$TemperatureImpl({required this.value, required this.unit})
      : super._();
...
abstract class _Temperature extends Temperature {
  const factory _Temperature(
      ...
      required final TemperatureUnit unit}) = _$TemperatureImpl;
