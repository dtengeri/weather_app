...
class _$AppSettingsImpl implements _AppSettings {
  const _$AppSettingsImpl({this.temperatureUnit = TemperatureUnit.celsius});
  ...
  @override
  String toString() {
    return 'AppSettings(temperatureUnit: $temperatureUnit)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, temperatureUnit);
...
abstract class _AppSettings implements AppSettings {
  const factory _AppSettings({final TemperatureUnit temperatureUnit}) =
      _$AppSettingsImpl;
